...
// Panel de detalle/edición de una tarea, sin el "cascarón" (fondo + posicionamiento fijo).
// Lo usa TaskDrawer (como slide-over independiente) y ProjectTasksSlideOver (embebido
// en la transición lista -> detalle).
export function TaskDetailPanel({ taskId, projectId, initialTitle, onSaved, onClose, backLabel = "✕", closeOnSave = false }) {
            ...
            {!isCreate && canEditCore && (
              <>
                <div className="rounded-md border border-border p-4">
                  ...
                  {task?.standby_start_date ? (
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      />
                      <DatePicker value={standbyStartDate} onChange={setStandbyStartDate} />
                      <button
                        onClick={setStandby}
                ...
                <div className="rounded-md border border-border p-4">
                  ...
                  {task?.cancel_date ? (
                    <div className="flex flex-col gap-2 text-sm">
                      <p>Cancelada el {new Date(task.cancel_date + "T00:00:00").toLocaleDateString("es-CO")}</p>
