      ...
      <form onSubmit={handleAdd} className="mb-4 flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-md border border-border bg-white px-3 py-2 text-xs outline-none focus:border-foreground"
          />
          <button
            type="submit"
              ...
              {editingId === item.id ? (
                <div className="flex flex-1 items-center gap-1.5">
                  ...
                  <input
                    ...
                    onBlur={saveEdit}
                    className="rounded border border-border px-1 py-0.5 text-xs outline-none"
                  />
                </div>
              ) : (
                <button
